...
const EnrollmentProofScreen: React.FC<EnrollmentProofScreenProps> = ({
  accessToken,
  onBack
}) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log('📤 Submitting enrollment proof request:', requestData);
      ...
      if (response.success) {
        ...
        Alert.alert(
          'نجح',
          response.message || 'تم إرسال طلب إثبات القيد بنجاح',
          [
            {
              text: 'موافق',
              onPress: () => onBack()
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerTitleContainer}>
          <Text style={styles.headerTitle}>📄 طلب إثبات قيد</Text>
        </View>
        ...
        <View style={styles.formCard}>
          ...
          <View style={styles.fieldGroup}>
            ...
            <CustomInput
              ...
              placeholder="مثالاً: للتقديم في وظيفة، للبنك، إلخ..."
              multiline
              numberOfLines={6}
