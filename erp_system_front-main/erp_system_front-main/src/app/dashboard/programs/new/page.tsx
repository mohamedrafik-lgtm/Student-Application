...
function NewProgramPageContent() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      toast.error('فشل في إنشاء البرنامج. يرجى المحاولة مرة أخرى.');
    } finally {
    ...
    return (
      <div className="space-y-6">
        <PageHeader
          ...
          description="املأ النموذج أدناه لإضافة برنامج تدريبي جديد إلى النظام."
          breadcrumbs={[
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
                ...
                <div className="bg-white rounded-xl border border-slate-200 shadow-sm">
                  ...
                  <div className="p-5">
                    ...
                    <p className="text-xs text-slate-500 mt-3">
                      تأكد من مراجعة جميع البيانات قبل الحفظ. سيظهر البرنامج في القائمة العامة فور إنشائه.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-6 py-4 bg-white border-t border-slate-200 flex justify-end gap-3 sticky bottom-0 px-6 rounded-b-xl">
              ...
              >
                {isSubmitting ? 'جاري الإنشاء...' : 'إنشاء البرنامج'}
              </Button>
            </div>
          </form>
        </Form>
