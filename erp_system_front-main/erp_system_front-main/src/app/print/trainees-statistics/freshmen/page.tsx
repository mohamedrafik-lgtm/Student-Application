...
export default function PrintFreshmenReportPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // فلترة المستجدين فقط
        const freshmen = allTrainees.filter((t: any) => 
          (t.status || 'FRESHMAN') === 'FRESHMAN'
        );
        
        setTrainees(freshmen);
    ...
    <div className="min-h-screen bg-white text-black" dir="rtl">
      ...
      <div className="print-container">
        ...
        <div className="header">
          ...
          <h2 className="subtitle">سجل قيد المستجدين</h2>
        ...
        <div className="stats-card">
          ...
          <div className="stat-label">إجمالي المستجدين 🎓</div>
        </div>

        {/* جدول المستجدين */}
        <div style={{marginTop: '30px'}}>
          <h3 style={{fontSize: '20px', fontWeight: 'bold', marginBottom: '15px', color: '#0A2647'}}>
            📋 قائمة الطلاب المستجدين
          </h3>
          
          {trainees.length === 0 ? (
            <div style={{textAlign: 'center', padding: '40px', color: '#666'}}>
              لا يوجد طلاب مستجدين
            </div>
          ) : (
        ...
        <div style={{textAlign: 'center', borderTop: '2px solid #ddd', paddingTop: '20px', marginTop: '40px', fontSize: '11px', color: '#666'}}>
          ...
          <p>نظام إدارة المتدربين - سجل قيد المستجدين</p>
