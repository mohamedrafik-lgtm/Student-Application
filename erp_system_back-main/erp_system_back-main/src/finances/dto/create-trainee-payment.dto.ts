...
export class CreateTraineePaymentDto {
  @ApiProperty({ description: 'معرف رسوم المتدرب' })
  @IsNotEmpty({ message: 'يجب تحديد رسوم المتدرب' })
  @IsNumber({}, { message: 'معرف رسوم المتدرب يجب أن يكون رقمًا' })
  feeId: number;
